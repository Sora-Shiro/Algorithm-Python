...
def checkio(numbers_array):
    import math
    return sorted(numbers_array, key = lambda x:math.fabs(x))

    # middle = []
    # for e in numbers_array:
    #     absolute = fabs(e)
    #     middle.append((e, absolute))
    # middle_sort = sorted(middle, key = lambda x:x[1])
    # numbers_array = []
    # for e in middle_sort:
    #     numbers_array.append(e[0])
